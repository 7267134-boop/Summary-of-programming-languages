...
// Track if we are inside a script block to skip it
...
for (let i = 0; i < lines.length; i++) {
    ...
    if (tabMatch) {
        ...
        if (currentTab) {
            currentTab.endLine = i; // ends at the line before this tab starts
            tabs.push(currentTab);
        }
    ...
    if (currentTab) {
        // Count divs in this line, excluding lines that are fully comments
...
console.log("=== Tab Balance Analysis ===");
tabs.forEach(t => {
